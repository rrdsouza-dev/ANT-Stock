 ...
 * exist in the menu (Entradas/Saídas, Picking, Gestão Escolar, Usuários, Support). */
    ...
    AppShell(root, ctx.path, (content) => {
      content.append(
        ...
        el("div", { class: "card card-pad", style: "text-align:center;padding:60px 20px" }, [
          ...
          el("h3", { text: "Em breve" }),
          el("p", { class: "muted", text: "Esta área será conectada ao backend FastAPI/Supabase nas próximas etapas." }),
        ]),
      );
      renderIcons(content);
    });
